...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/scikit-hep-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scikit-hep-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install scikit-hep
```
...
It is possible to list all of the versions of `scikit-hep` available on your platform:
...
```
pixi search scikit-hep --channel conda-forge
```
